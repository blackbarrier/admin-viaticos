...
#[ORM\Entity(repositoryClass: InfoDependenciaRepository::class)]
class InfoDependencia 
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne]
    private ?Dependencia $dependenciaReferencia = null;
    ...
    public function getDependenciaReferencia(): ?Dependencia
    {
        return $this->dependenciaReferencia;
    }

    public function setDependenciaReferencia(?Dependencia $dependenciaReferencia): static
    {
    ...
    //     $string = "INFO_DEPENDENCIA => id:".$this->getId().",nombre:".$this->getNombre().",abreviatura:".$this->getAbreviatura().",codigoGDEBA:".$this->getCodigoGdeba();
    //     $string .=",descripcion:".$this->getDescripcion().",dependenciaRenaperId:".$this->getDependenciaRenaperId().",estadoDependenciaId:".$this->getEstadoDependenciaId();
    //     $string .=",clase:".$this->getClase().",fechaVigenciaDesde:".$this->getFechaVigenciaDesde().",fechaVigenciaHasta:".$this->getFechaVigenciaHasta().",fechaCarga:".$this->getFechaCarga();
    //     $string .=",usuarioCargaId:".$this->getUsuarioId();
    //     return $string;
    // }
